...
<table width="98%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="이 표는 약관내용 대상 정보를 제공하며, 이용약관명, 이용약관내용, 정보제공동의내용 정보로 구성되어 있습니다 .">
  ...
  <tr> 
    ...
    <td width="80%" nowrap>    
      <textarea name="useStplatCn" class="textarea" title="이용약관내용 입력"  cols="300" rows="20"  style="width:450px;" readonly><c:out value="${result.useStplatCn}"/>
      </textarea>                 
    </td>
  </tr> 
  ...
  <tr> 
    ...
    <td width="80%" nowrap>    
      <textarea name="infoProvdAgreCn" class="textarea" title="정보제공동의내용 입력" cols="300" rows="20"  style="width:450px;" readonly><c:out value="${result.infoProvdAgreCn}"/>
      </textarea>                 
    </td>
  </tr> 
