...
public class CpyrhtPrtcPolicyDAO extends EgovComAbstractDAO {
    ...
    public CpyrhtPrtcPolicyVO selectCpyrhtPrtcPolicyDetail(CpyrhtPrtcPolicyVO vo) throws Exception {
        ...
        return (CpyrhtPrtcPolicyVO) selectByPk("CpyrhtPrtcPolicyDAO.selectCpyrhtPrtcPolicyDetail", vo);
    ...
    public List selectCpyrhtPrtcPolicyList(CpyrhtPrtcPolicyDefaultVO searchVO) throws Exception {
        ...
        return list("CpyrhtPrtcPolicyDAO.selectCpyrhtPrtcPolicyList", searchVO);
    ...
    public int selectCpyrhtPrtcPolicyListTotCnt(CpyrhtPrtcPolicyDefaultVO searchVO) {
        ...
        return (Integer)getSqlMapClientTemplate().queryForObject("CpyrhtPrtcPolicyDAO.selectCpyrhtPrtcPolicyListTotCnt", searchVO);
