...
public class IndvdlInfoPolicyDao extends EgovComAbstractDAO {
    ...
    public List selectIndvdlInfoPolicyList(ComDefaultVO searchVO) throws Exception {
        return (List)list("IndvdlInfoPolicy.selectIndvdlInfoPolicy", searchVO);
    }
    ...
    public int selectIndvdlInfoPolicyListCnt(ComDefaultVO searchVO) throws Exception {
        return (Integer)getSqlMapClientTemplate().queryForObject("IndvdlInfoPolicy.selectIndvdlInfoPolicyCnt");
    }
    ...
    public IndvdlInfoPolicy selectIndvdlInfoPolicyDetail(IndvdlInfoPolicy indvdlInfoPolicy) throws Exception {
        return (IndvdlInfoPolicy)getSqlMapClientTemplate().queryForObject("IndvdlInfoPolicy.selectIndvdlInfoPolicyDetail", indvdlInfoPolicy);
    }
